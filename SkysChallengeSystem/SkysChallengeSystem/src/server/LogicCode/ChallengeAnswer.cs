...
public class ChallengeAnswer : LogicComponent<IChallengeAnswerData>
{
    ...
    protected void Connect() => ChallengeBoard?.ConnectAnswer(currentName, Inputs[0]);
    protected void Disconnect() => ChallengeBoard?.DisconnectAnswer(currentName, Inputs[0]);
